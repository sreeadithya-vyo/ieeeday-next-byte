      ...
      <section className="relative min-h-[600px] overflow-hidden">
        ...
        <div className="container relative mx-auto flex min-h-[600px] items-center px-4">
          <div className="max-w-3xl animate-fade-in">
            ...
            <h2 className="mb-3 text-xl font-medium leading-relaxed text-white md:text-2xl lg:text-3xl">Sasi Institute of Technology and Engineering, Tadepalligudem Organizes 2025 IEEE Day Celebrations</h2>
